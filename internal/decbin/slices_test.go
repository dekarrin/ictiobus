...
func Test_EncSliceBinary(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expect: []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x03, 0xaf, 0xff, 0xde, 0x83},
		},
		{
			name: "two items",
			input: []encoding.BinaryMarshaler{
			...
			expect: []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x16, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06, 0x28, 0x03, 0x00, 0x00, 0x12, 0x17},
		},
	}
