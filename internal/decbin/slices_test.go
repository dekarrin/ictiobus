...
func Test_EncSliceString(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			name:   "one item",
			input:  []string{"one"},
			expect: []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x6f, 0x6e, 0x65},
		},
		{
			name:   "two items",
			input:  []string{"one", "two"},
			expect: []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x16, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x6f, 0x6e, 0x65, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x74, 0x77, 0x6f},
		},
	}
...
func Test_DecSliceString(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			input:       []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x6f, 0x6e, 0x65, 0x00, 0xfe},
			expectValue: []string{"one"},
			expectRead:  19,
		},
		{
			name:        "two items",
			input:       []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x16, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x6f, 0x6e, 0x65, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x74, 0x77, 0x6f},
